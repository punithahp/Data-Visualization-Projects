...
#Do the below installs before executing the code in the terminal
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        #non_recession_data = data[data['Year'] == input_year]
    #else:
        #raise ValueError("Invalid report type. Choose 'Recession Period Statistics' or 'Yearly Statistics'.")
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        filtered_data = avr_vdata[avr_vdata['Year'] == input_year]
        Y_chart3 = dcc.Graph(figure=px.bar(filtered_data,
                                                x='Vehicle_Type',                # X-axis: Vehicle types
                                                y='Automobile_Sales',            # Y-axis: Average automobile sales
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(data_frame=exp_data,
                                                values='Advertising_Expenditure',  # Total advertisement expenditure
                                                names='Vehicle_Type',              # Vehicle type categories
